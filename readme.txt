...
Lets say you want your wordpress to be in Macedonian. So you intall wordpress, install the Macedonian language files, translate the template menus and stuff to Macedonian, but after your first post whit title: "Здраво Свет!" you noticed that the url for that post has become something like:
